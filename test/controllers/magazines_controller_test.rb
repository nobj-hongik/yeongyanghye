...
class MagazinesControllerTest < ActionController::TestCase
  ...
  test "should create magazine" do
    assert_difference('Magazine.count') do
      post :create, magazine: { category: @magazine.category, content: @magazine.content, image: @magazine.image, title: @magazine.title }
    end
  ...
  test "should update magazine" do
    patch :update, id: @magazine, magazine: { category: @magazine.category, content: @magazine.content, image: @magazine.image, title: @magazine.title }
    assert_redirected_to magazine_path(assigns(:magazine))
  end
